...
public class SolrIntegrationTest implements ApiTest {
    ...
    public static void beforeClass() throws IOException, InterruptedException, SolrServerException {
        ...
        arclibXml = new String(Files.readAllBytes(Paths.get("src/test/resources/arclibXml.xml")), StandardCharsets.UTF_8);
    }
    ...
    public void testCreateIndexInvalidFieldValue() throws Exception {
        String arclibXml = new String(Files.readAllBytes(Paths.get("src/test/resources/invalidValue.xml")), StandardCharsets.UTF_8);
