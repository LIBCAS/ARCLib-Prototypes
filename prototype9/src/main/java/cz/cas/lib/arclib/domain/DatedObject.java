 ...
 * which are filled accordingly in {@link cz.cas.lib.arclib.store.DatedStore}.
 * </p>
 * <p>
 * <p>
 * If used with {@link cz.cas.lib.arclib.store.DatedStore} upon deleting an instance, the instance will not be deleted
